...
public class CourseService
{
    ...
    if(estudiante != null && curso !=null) {
    	...
    	System.out.println("El estudiante " + studentId + " se matriculó en " + courseId);
    }else {
        ...
        //TODO implement so it removes the given course form the student
    	 Student estudiante = students.get(studentId);
    	    ...
    	    if(estudiante != null && curso !=null) {
    	    	...
    	    	System.out.println("El estudiante " + studentId + " Se dio de baja de " + courseId);
    	    }else {
    	    	System.out.println("Error en el sistema");
    	    }
    	    }
    ...
    public void displayCourseInformation(String courseId){
    	...
    	Course curso = courses.get(courseId);
    	if(curso !=null) {
    		System.out.println(curso.name +  " " + courseId + " " + curso.credits);
    	}else {
    		System.out.println("Error en el sistema");
    	}
    }
    ...
    public void displayStudentInformation(String studentId){
    	...
    	Student estudiante = students.get(studentId);
    	if(estudiante !=null) {
    		System.out.println(estudiante.name +  " " + estudiante.id + " " + estudiante.enrolledCourses.size());
    	}else {
    		System.out.println("Error en el sistema");
    }
    }
